...
export default function LoginScreen({ onLoginSuccess, onNavigateToRegister, onOpenSettings }) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Login failed. Please check credentials and server connection.');
    } finally {
      setLoading(false);
    }
  };
          ...
          <ScrollView contentContainerStyle={styles.scrollContent}>
            ...
            <View style={styles.formContainer}>
              ...
              <View style={styles.toggleRow}>
                <Text style={styles.toggleText}>Don't have a vault?</Text>
            ...
            >
              <Ionicons name="server-outline" size={16} color="#D1B875" />
              <Text style={styles.settingsButtonText}>Configure Server API</Text>
            </Pressable>
          </ScrollView>
        </KeyboardAvoidingView>
      </SafeAreaWrapper>
...
// Simple wrapper to avoid duplicating SafeAreaView styling
